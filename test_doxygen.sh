...
$DOCEXTRACT -i ../de_tahifi_errors.xml         -o de_tahifi_errors.md        -H de_tahifi_errors.h        -c tdbus              -s de.tahifi.                -n Errors
$DOCEXTRACT -i ../de_tahifi_filetransfer.xml   -o de_tahifi_dbusdl.md        -H de_tahifi_dbusdl.h        -c tdbus              -s de.tahifi.                -n DBus-DL
$DOCEXTRACT -i ../de_tahifi_jsonio.xml         -o de_tahifi_jsonio.md        -H de_tahifi_jsonio.h        -c tdbus              -s de.tahifi.                -n 'Generic exchange of JSON objects'
...
$DOCEXTRACT -i ../io_gerbera.xml               -o io_gerbera.md              -H io_gerbera.h              -c tdbus              -s io.                       -n 'Gerbera UPnP server'
